...
export default function EditFacture({ aff, patient, factureData }) {
    // ==================== HOOKS REDUX ====================
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="btns">
                        ...
                        <button
                            ...
                            style={{
                                opacity: (!hasChanges() && formData.libelle && formData.type && formData.montant) ? 0.6 : 1
                            }}
                        >
                            {updateStatus === 'loading' ? 'Modification...' : 'Modifier et Imprimer'}
                        </button>
                    </div>
                </form>
            </div>
