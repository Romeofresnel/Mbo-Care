import { Bed, CircleOff, HandHeart, Plus, UserRound } from "lucide-react";
...
export default function Patient() {
  ...
  return (
    <>
        ...
        <div className="patients-top">
          ...
          <div className="patients-nav">
            ...
            <div className="patients-option">
              <FontAwesomeIcon icon={faSistrix} onClick={toggleSearch} title={showSearch ? "Fermer la recherche" : "Ouvrir la recherche"} />
              {patients.length === 0 ? (
                ''
              ) : (
                <button
      ...
      {showAddModal && (
        <AddNewPatient aff={closeAddModal} />
      )}
